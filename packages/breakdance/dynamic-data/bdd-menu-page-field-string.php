...
/** 
 * Breakdance Dynamic Fields for Menu Page Fields (string) 
 * @package VXN\Express\Breakdance\Dynamic_Data
 * @author Vaksin <dev@vaks.in>
 * @since 1.1
 */
class BDD_Menu_Page_Field_String extends StringField implements BDD_Menu_Page_Field
{
use BDD_Field_String;
    ...
    {
        return $this->menu_page['page_title'] . ' Fields';
    }
    ...
    {
        return 'vxn_express_' . $this->menu_page['slug'] . '_menu_page_string_fields';
    }
